          ...
          <AreaChart data={filteredData}>
            <defs>
              <linearGradient id='fillDesktop' x1='0' y1='0' x2='0' y2='1'>
                <stop offset='5%' stopColor='#F34F3F' stopOpacity={1.0} />
                <stop offset='95%' stopColor='#F34F3F' stopOpacity={0.1} />
              </linearGradient>
              <linearGradient id='fillMobile' x1='0' y1='0' x2='0' y2='1'>
                <stop offset='5%' stopColor='#d8200e' stopOpacity={0.8} />
                <stop offset='95%' stopColor='#d8200e' stopOpacity={0.1} />
              </linearGradient>
            </defs>
